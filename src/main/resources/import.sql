...
INSERT INTO CUSTOMER ( ID, ADDRESS, BIO, BIRTHDAY, CITY, CUSTOMER_ROLE, DISABLE_END_DATE, DISABLE_REASON, DISABLE_START_DATE, EMAIL, NAME, PASSWORD, PHONE, REGISTRATION_DATE, STATUS, USERNAME, VERSION, SEX ) VALUES ( 1, '张三地址', '', NULL, '北京', 0, NULL, '', NULL, 'a@a.a', '张三', '0000', '010100000', '2012-03-07 00:00:00', 0, '张阿三', 0, 2 );
