 ...
 * <p/>
 * <p>This class was extracted from the SpringByExample bundle,
 * as we only wanted this feature.
...
public class AnnotationLoggerBeanPostProcessor extends LoggerBeanPostProcessor {
     ...
     * Defaults to <code>AutowiredLogger</code>.
     *
     * @param autowiredAnnotationType {@link Class}
     */
        ...
        ReflectionUtils.doWithFields( clazz, new ReflectionUtils.FieldCallback() {
            public void doWith( Field field ) {
                ...
                if ( annotation != null ) {
                    ...
                    Object logger = getLogger( bean.getClass().getName(), field.getType().getName() );
