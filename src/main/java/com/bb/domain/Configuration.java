...
public class Configuration {
    ...
    @Id
    @SequenceGenerator(name = "configurationGen", sequenceName = "CONFIGURATION_SEQ")
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "configurationGen")
    @Column(name = "id")
    private Long id;
    ...
    public static Configuration findConfiguration(Long id) {
    ...
    public void remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Configuration attached = findConfiguration(this.id);
