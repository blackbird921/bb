...
import com.bb.web.CustomerProductController;
...
privileged aspect CustomerProductController_Roo_Controller {
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String CustomerProductController.create(@Valid CustomerProduct customerProduct, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String CustomerProductController.createForm(Model uiModel) {
    ...
    public String CustomerProductController.show(@PathVariable("id") Long id, Model uiModel) {
        addDateTimeFormatPatterns(uiModel);
        uiModel.addAttribute("customerproduct", CustomerProduct.findCustomerProduct(id));
        uiModel.addAttribute("itemId", id);
        return "customerproducts/show";
    }
    
    @RequestMapping(produces = "text/html")
    public String CustomerProductController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String CustomerProductController.update(@Valid CustomerProduct customerProduct, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, customerProduct);
    ...
    public String CustomerProductController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, CustomerProduct.findCustomerProduct(id));
        return "customerproducts/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String CustomerProductController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void CustomerProductController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    void CustomerProductController.populateEditForm(Model uiModel, CustomerProduct customerProduct) {
    ...
    String CustomerProductController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
