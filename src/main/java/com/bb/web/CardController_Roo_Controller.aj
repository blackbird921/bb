...
import com.bb.web.CardController;
...
privileged aspect CardController_Roo_Controller {
    ...
    public String CardController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
        if (page != null || size != null) {
            ...
            uiModel.addAttribute("cards", Card.findCardEntries(firstResult, sizeNo));
            float nrOfPages = (float) Card.countCards() / sizeNo;
    ...
    void CardController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("card_startdate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("card_enddate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("card_createdate_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
