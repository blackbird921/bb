...
<script type="text/javascript">
    $(document).ready(function () {
        document.getElementById('password_repeat').setAttribute('required', 'true');
...
//                    return !input.is("[id=password_repeat]") ||
//                              $("#password_repeat").val() != $("#password_id").val();
//                }
//            }
        }).data("kendoValidator");
...
<div id="main">
    ...
    <div id="example" class="k-content">
        <div id="form-wrapper" class="k-header" style="height: 300px;">
            <form:create id="fc_com_bb_domain_Customer" modelAttribute="customer" multipart="true" path="/customers">
                ...
                <%--<field:input field="password_repeat" id="password_repeat" label="确认密码"  disableFormBinding="true"/>--%>
