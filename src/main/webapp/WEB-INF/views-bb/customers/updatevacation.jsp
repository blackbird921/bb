...
<div id="main">
    ...
    <div id="example" class="k-content">
        ...
        <div id="form-wrapper" class="k-header" style="height: 200px; width:400px;">
            <form:update id="fu_com_bb_domain_Customer" modelAttribute="customer" multipart="true" path="/customers/update" versionField="Version" z="user-managed" label="递交">
                ...
                <script>
                    ...
                    <li style="margin:15px 0; !important">
                        ...
                        <input id="c_com_bb_domain_Customer_disableStartDate" name="disableStartDate" type="text" value="${formatStartDate}" class="k-textbox"/>
                    </li>
                    <script src="/resources/scripts/jquery-ui/development-bundle/ui/i18n/jquery.ui.datepicker-zh-CN.js" type="text/javascript">
                        <!--jquery ui-->
                    </script>
